...
tabella_confronti <- function(dataset, classe, R = NULL, seed = NULL,...) {
  ...
  MSE_bcv_3nn <- MSE_BIAS_BCV(dataset, classe = classe, R = R, train = train_3nn, classify = classify_knn, seed = seed)$MSE
  ...
  BIAS_bcv_3nn <- MSE_BIAS_BCV(dataset, classe = classe, R = R, train = train_3nn, classify = classify_knn, seed = seed)$Bias
  ...
  data <- data.frame(
    MSE1_3nn = c(MSE_boot_3nn , MSE_632_3nn, MSE_632_plus_3nn, MSE_cv_3nn, MSE_bcv_3nn), 
    Bias1_3nn = c(BIAS_boot_3nn , BIAS_632_3nn, BIAS_632_plus_3nn, BIAS_cv_3nn, BIAS_bcv_3nn),
    ...
    MSE5_qda = c(MSE_boot_qda , MSE_632_qda, MSE_632_plus_qda, MSE_cv_qda, MSE_bcv_qda), 
    Bias5_qda = c(BIAS_boot_qda , BIAS_632_qda, BIAS_632_plus_qda, BIAS_cv_qda, BIAS_bcv_qda)
  )
...
# tabella_iris <- tabella_confronti(iris, classe = 5, R = 5, seed = 123)
tabella_iris
